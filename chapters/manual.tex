...
\subsection{Ruby Installieren}\label{subsec:rubyinstallieren}
\begin{frame}[fragile]
...
\subsection{Ruby gehversuche}\label{subsec:rubygehversuche}
\begin{frame}[fragile]
...
\begin{frame}[fragile]
    ...
    \figureStyle{width=0.40\textwidth}{08_tree}{Simple Projektstruktur}{fig:projektstruktur}
